...
let NtlmProxyMitm = class NtlmProxyMitm {
    constructor(configStore, portsConfigStore, connectionContextManager, winSsoFacade, negotiateManager, ntlmManager, upstreamProxyManager, debug) {
    ...
    getTargetHost(ctx) {
        ...
        const hostUrl = url_converter_1.toCompleteUrl(host, ctx.isSSL, true);
    ...
    onConnect(req, socket, head, callback) {
        ...
        const targetHost = url_converter_1.toCompleteUrl(req.url, true, true);
